...
internal unsafe struct Generation
{
    ...
    [FieldOffset(56)]
    public HeapSegment* start_segment;

    [FieldOffset(64)]
    public HeapSegment* allocation_segment;

    [FieldOffset(72)]
    public IntPtr allocation_context_start_region;

    [FieldOffset(80)]
    public HeapSegment* tail_region;

    [FieldOffset(88)]
    public HeapSegment* plan_start_segment;

    [FieldOffset(96)]
    public HeapSegment* tail_ro_region;
